...
class CLexer(object):
    """ A lexer for the C language. After build(), set the input text with input(),
        and then call token() to get new tokens.
    """
    ...
    def _init_keyword_map(self):
        for keyword in self.keywords:
            if keyword == '_BOOL':
                self.keyword_map['_Bool'] = keyword
            elif keyword == '_COMPLEX':
                self.keyword_map['_Complex'] = keyword
            else:
                self.keyword_map[keyword.lower()] = keyword
